...
echo -e "\e[34mWebPlotViz file \e[92m$PWD/$folderName/plot.webplotviz \e[34mcreated. Please check the clusters by uploading it to WebPlotViz. Execute following command on local machine to download plot file\e[0m"
echo -e "\e[93mscp -r $usrname@$hostname:$PWD/$folderName/plot.webplotviz ./ \e[0m"
...
echo -e "\e[34mJoined cluster file \e[92m$PWD/$folderName/cluster_joined.txt\e[34m and plot file \e[92m$PWD/$folderName/plot_joined.webplotviz\e[34m created Check plot to identify clusters that need to be seperated. Execute following command on local machine to download plot file\e[0m"
echo -e "\e[93mscp -r $usrname@$hostname:$PWD/$folderName/plot_joined.webplotviz ./ \e[0m"
...
echo -e "Execute following command on local machine to download plot file"
echo -e "\e[93mscp -r $usrname@$hostname:$PWD/$pwcFolderNew/plot_joined.webplotviz ./ \e[0m"
echo -e "\e[41mPlease provide clusters that need to be merged in the following format 0+2|4+5|. Join 0 and 2. Also join 4 and 5\e[0m"
